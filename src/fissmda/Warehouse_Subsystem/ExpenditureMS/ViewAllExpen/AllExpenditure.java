 ...
 * @author melan
 */
public class AllExpenditure extends javax.swing.JFrame {
    ...
    ResultSet rs = null;
    /**
     * Creates new form AllExpenditure
     */
    ...
    public void totalExpense(){
        ...
        float totalExp = 0;
        String sqlExec = "SELECT * FROM expenditure";
        try {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Warehouse Expenditures ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllExpenditure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
